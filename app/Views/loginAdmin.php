...
<body class="m-0 vh-100 row justify-content-center align-item-center" style=background-color:rgb(171,178,185);">
<h4>ACCESO ADMINISTRADORES</h4> 


<div class="abs-center mt-5">
<img src="Images/administrador2.jpg" width="250" height="250">
</div>
  <div class="col-xxl-5 col-lg-5 col-md-7 col-sm-10 pt-5">
    <div class="card-header text-center"><h3>Administrador</h3></div>
      <div class="card-body">
      <form method="post" action="<?=base_url('validarAdmin')?>" enctype="multipart/form-data">
  ...
  <button class="btn btn-danger" type="submit ">Acceder</button>
</form>
      </div>
    </div>
